...
export class ChecklistPage implements OnInit {
  ...
  constructor( private alterCtrl: AlertController, private route: ActivatedRoute, private dataService: ChecklistDataService){
 ...
 loadChecklist(){
  ...
  renameItem(item): void {
    this.alterCtrl.create({
      header: 'Rename Item',
      message: ' Enter the new name of the tesk for this checklist below:, ',
      inputs: [
        {
          type: 'text',
          name: 'name'
